                ...
                <div className="flex items-center gap-x-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-row gap-3">
                            ...
                            rounded-md bg-richblack-700 py-2 px-5 font-semibold text-richblack-50"> Select</button>
                            
                            <button className="bg-yellow-50 text-black px-5 flex items-center rounded-md gap-x-2"
