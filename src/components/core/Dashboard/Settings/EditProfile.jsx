        ...
        <>
            <form onSubmit={handleSubmit(submitProfileForm)}>
                ...
                <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="firstName" id="firstName" placeholder="Enter first name"
                                className="bg-richblack-700 py-2 px-2 rounded-md" {...register("firstName", { required: true })}
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                ...
                                className="bg-richblack-700 py-2 px-2 rounded-md" {...register("lastName", { required: true })}
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row">
                        <div className="flex flex-col gap-2 lg:w-[48%]">
                            ...
                            <input type="date" name="dateOfBirth" id="dateOfBirth" className="bg-richblack-700 py-2 px-2 rounded-md"
                        ...
                        <div className="flex flex-col gap-2 lg:w-[48%]">
                            ...
                            <select type="text" name="gender" id="gender" className="bg-richblack-700 py-2 px-2 rounded-md"
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button className="bg-yellow-25">Save</button>
                </div>
            </form>
        </>
    );
